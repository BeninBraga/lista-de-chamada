...
const index19 = Number_alunos0.indexOf(19);
if (index19 !== -1) {
    Number_alunos0[index19] = 35;
    Name_alunos0[index19] = "LUIZ INACIO LULA";
}

// Substituições na segunda lista
const index35 = Number_alunos1.indexOf(35);
if (index35 !== -1) {
    Number_alunos1[index35] = 19;
    Name_alunos1[index35] = Name_alunos0[index19]; // Usando o nome correspondente da primeira lista
}
